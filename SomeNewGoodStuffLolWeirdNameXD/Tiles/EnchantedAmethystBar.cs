...
{
    public class EnchantedAmethystBar : ModTile
    {
        public override void SetDefaults()
        {
            ...
            drop = mod.ItemType("EnchantedAmethystBarInv"); // What item drops after destorying the tile
            ModTranslation name = CreateMapEntryName();
            name.SetDefault("Enchanted Amethyst Bar");
